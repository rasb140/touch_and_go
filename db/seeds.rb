...
plane = Airplane.new({ brand_and_model: "GULFSTREAM G700", weight: 48_806, registration: "N700GS", range: 7_500, speed: "MACH 0.90", max_altitude: 51_000, number_of_engines: 2, pax_capacity: 10, address: "9500-749 Ponta Delgada" })
plane.user = rodrigo
...
plane = Airplane.new({ brand_and_model: "DASSAULT FALCON 8X", weight: 33_112, registration: "CS-TCR", range: 6_450, speed: "MACH 0.90", max_altitude: 51_000, number_of_engines: 3, pax_capacity: 15, address: "95700 Roissy-en-France, France" })
plane.user = rodrigo
...
plane = Airplane.new({ brand_and_model: "CESSNA 152", weight: 750, registration: "CS-ASP", range: 768, speed: "107 Knots", max_altitude: 14_700, number_of_engines: 1, pax_capacity: 1, address: "Willy-Brandt-Platz 2, 12529 Schönefeld" })
plane.user = rodrigo
...
plane = Airplane.new({ brand_and_model: "BEECHCRAFT KING AIR 350I", weight: 6_804, registration: "F-KMJG", range: 1806, speed: "312 Knots", max_altitude: 35_000, number_of_engines: 2, pax_capacity: 11, address: "Innsbruck (Airport), 6020 Innsbruck, Austria" })
plane.user = rodrigo
...
plane = Airplane.new({ brand_and_model: "AIRBUS ACJ 319", weight: 78_200, registration: "G-JFOG", range: 6000, speed: "MACH 0.82", max_altitude: 41_000, number_of_engines: 2, pax_capacity: 50, address: "9500-749 Ponta Delgada" })
plane.user = rodrigo
...
plane = Airplane.new({ brand_and_model: "VELIS ELECTRO", weight: 600, registration: "CS-AEL", range: 75, speed: "90 Knots", max_altitude: 12_000, number_of_engines: 1, pax_capacity: 1, address: "John F. Kennedy International Airport" })
plane.user = rodrigo
